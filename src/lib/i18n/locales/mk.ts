...
export const mk: Translations = {
    lastUpdate: "Последно ажурирање: 17 септември 2026",
    ...
    experience: {
        ...
        descriptions: {
            ...
            absoft_desc: "Тестирање на уреди и мобилни апликации за видео-рекордер",
    ...
    errorPage: {
        ...
        notFoundText: "Оваа адреса не постои. Јазичниот код во врската можеби е погрешен.",
        genericTitle: "Нешто тргна наопаку",
        genericText: "Страницата не можеше да се прикаже. Обично помага повторно вчитување.",
        backHome: "Назад кон биографијата"
    },
    ai: {
        subtitle: "Залепете текст на оглас или врска до него — AI ќе го спореди со искуството на Алик.",
        jobPlaceholder: "Опис на работното место или врска до огласот...",
        analyze: "Анализирај го огласот",
        analyzing: "Анализирам...",
        newAnalysis: "Нова анализа",
        newAnalysisHint: "Анализирај друг оглас",
        rawTitle: "Одговор на AI",
        rawNote: "Моделот не врати структурирана оцена — текстот е прикажан непроменет.",
        summaryTitle: "Заклучок на AI",
        matchLabel: "Совпаѓање",
        ...
        bannerSub: "Проверете колку огласот одговара на кандидатот",
        open: "Отвори AI Job Matcher",
        statusNoKey: "нема клуч",
        statusCooldown: "лимит ~{minutes} мин",
        statusAnswered: "одговори",
        statusReady: "подготвен",
        tooltipAnswered: "Одговори {model} ({provider}). Кликнете за да изберете друг.",
        tooltipWillTry: "Прво ќе се обиде {model} ({provider}). Кликнете за да изберете друг.",
        pinHint: "Избраниот модел се обидува прв. Ако ја потроши квотата, барањето автоматски оди на следниот.",
        emptyAnswer: "Моделот врати празен одговор. Обидете се повторно или изберете друг модел на ознаката горе.",
        errorNetwork: "Не успеавме да стигнеме до AI-услугата. Проверете ја врската и обидете се повторно.",
        errorTimeout: "AI-услугата не одговори навреме. Обидете се повторно.",
        errorRateLimitMinute: "Премногу барања едно по друго. Обидете се по една минута.",
        errorRateLimitDay: "Дневниот лимит на барања е исцрпен. Обидете се утре.",
        errorUnavailable: "Во моментов нема достапен модел. Обидете се по неколку минути или изберете друг модел на ознаката горе.",
        errorGeneric: "AI-услугата врати неочекуван одговор ({status}). Обидете се повторно."
    }
};
