...
export const be: Translations = {
    lastUpdate: "Апошняе абнаўленне: 17 верасня 2026",
    ...
    ai: {
        subtitle: "Устаўце тэкст вакансіі або спасылку на яе — AI параўнае яе з досведам Аліка.",
        jobPlaceholder: "Апісанне вакансіі або спасылка на яе...",
        analyze: "Прааналізаваць вакансію",
        analyzing: "Аналізуем...",
        newAnalysis: "Новы аналіз",
        newAnalysisHint: "Прааналізаваць іншую вакансію",
        rawTitle: "Адказ AI",
        rawNote: "Мадэль не вярнула структураваную ацэнку — паказваем тэкст без зменаў.",
        summaryTitle: "Выснова AI",
        ...
        bannerSub: "Праверыць, наколькі вакансія супадае з кандыдатам",
        open: "Адкрыць AI Job Matcher",
        statusNoKey: "няма ключа",
        statusCooldown: "ліміт ~{minutes} хв",
        statusAnswered: "адказала",
        statusReady: "гатовая",
        tooltipAnswered: "Адказала мадэль {model} ({provider}). Націсніце, каб выбраць іншую.",
        tooltipWillTry: "Спачатку будзе спроба {model} ({provider}). Націсніце, каб выбраць іншую.",
        pinHint: "Абраная мадэль спрабуецца першай. Калі ў яе скончацца ліміты — запыт пойдзе далей па спісе аўтаматычна.",
        emptyAnswer: "Мадэль вярнула пустую адказ. Паспрабуйце яшчэ раз або выберыце іншую мадэль на бэйджы вышэй.",
        errorNetwork: "Не ўдалося звярнуцца да AI-сэрвісу. Праверце злучэнне і паспрабуйце яшчэ раз.",
        errorTimeout: "AI-сэрвіс не адказаў своечасова. Паспрабуйце яшчэ раз.",
        errorRateLimitMinute: "Занадта шмат запытаў запар. Паспрабуйце праз хвіліну.",
        errorRateLimitDay: "Дзённы ліміт запытаў вычарпаны. Паспрабуйце заўтра.",
        errorUnavailable: "Зараз ніводная мадэль недаступная. Паспрабуйце праз некалькі хвілін або выберыце іншую мадэль на бэйджы вышэй.",
        errorGeneric: "AI-сэрвіс вярнуў нечаканы адказ ({status}). Паспрабуйце яшчэ раз."
    }
};
