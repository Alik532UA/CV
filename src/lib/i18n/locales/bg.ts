...
export const bg: Translations = {
    ...
    experience: {
        ...
        descriptions: {
            ...
            absoft_desc: "Тестване на устройства и мобилни приложения за видеорекордер",
    ...
    errorPage: {
        ...
        notFoundText: "Такъв адрес не съществува. Езиковият код във връзката може да е грешен.",
        genericTitle: "Нещо се обърка",
        genericText: "Страницата не можа да бъде показана. Обикновено помага презареждане.",
        backHome: "Обратно към автобиографията"
    },
    ai: {
        subtitle: "Поставете текста на обява или връзка към нея — AI ще я сравни с опита на Алик.",
        jobPlaceholder: "Описание на позицията или връзка към обявата...",
        analyze: "Анализирай обявата",
        analyzing: "Анализиране...",
        newAnalysis: "Нов анализ",
        newAnalysisHint: "Анализирай друга обява",
        rawTitle: "Отговор на AI",
        rawNote: "Моделът не върна структурирана оценка — показваме текста без промени.",
        summaryTitle: "Заключение на AI",
        matchLabel: "Съвпадение",
        strengths: "Силни страни",
        gaps: "Пропуски и въпроси",
        followUpTitle: "Задайте допълнителен въпрос за опита на Алик:",
        chatPlaceholder: "Вашият въпрос за опита на Алик...",
        chatSend: "Изпрати въпроса",
        thinking: "AI мисли...",
        modelTitle: "Модел на AI",
        modelAuto: "Автоматично — най-добрият наличен",
        bannerSub: "Проверете доколко обявата съвпада с кандидата",
        open: "Отвори AI Job Matcher",
        statusNoKey: "няма ключ",
        statusCooldown: "лимит ~{minutes} мин",
        statusAnswered: "отговори",
        statusReady: "готов",
        tooltipAnswered: "Отговори {model} ({provider}). Щракнете, за да изберете друг.",
        tooltipWillTry: "Първо ще се опита {model} ({provider}). Щракнете, за да изберете друг.",
        pinHint: "Избраният модел се опитва пръв. Ако изчерпи лимита си, заявката автоматично продължава към следващия.",
        emptyAnswer: "Моделът върна празен отговор. Опитайте отново или изберете друг модел от значката горе.",
        errorNetwork: "Услугата с ИИ не беше достъпна. Проверете връзката и опитайте отново.",
        errorTimeout: "Услугата с ИИ не отговори навреме. Опитайте отново.",
        errorRateLimitMinute: "Твърде много заявки една след друга. Опитайте след минута.",
        errorRateLimitDay: "Дневният лимит от заявки е изчерпан. Опитайте утре.",
        errorUnavailable: "В момента няма достъпен модел. Опитайте след няколко минути или изберете друг модел от значката горе.",
        errorGeneric: "Услугата с ИИ върна неочакван отговор ({status}). Опитайте отново."
    }
};
