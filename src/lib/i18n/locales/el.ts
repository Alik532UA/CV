...
export const el: Translations = {
    lastUpdate: "Τελευταία ενημέρωση: 17 Σεπτεμβρίου 2026",
    ...
    experience: {
        ...
        present: "Σήμερα",
        companies: {
            theater_company: "Θεατρική Σχολή"
        },
        roles: {
    ...
    ai: {
        subtitle: "Επικολλήστε το κείμενο μιας αγγελίας ή έναν σύνδεσμο — η ΤΝ θα τη συγκρίνει με την εμπειρία του Alik.",
        jobPlaceholder: "Περιγραφή θέσης ή σύνδεσμος προς την αγγελία...",
        analyze: "Ανάλυση αγγελίας",
        analyzing: "Γίνεται ανάλυση...",
        newAnalysis: "Νέα ανάλυση",
        newAnalysisHint: "Ανάλυση άλλης αγγελίας",
        rawTitle: "Απάντηση ΤΝ",
        rawNote: "Το μοντέλο δεν επέστρεψε δομημένη αξιολόγηση — εμφανίζουμε το κείμενο ως έχει.",
        summaryTitle: "Συμπέρασμα ΤΝ",
        matchLabel: "Αντιστοιχία",
        ...
        bannerSub: "Ελέγξτε πόσο ταιριάζει η αγγελία με τον υποψήφιο",
        open: "Άνοιγμα AI Job Matcher",
        statusNoKey: "χωρίς κλειδί",
        statusCooldown: "όριο ~{minutes} λεπ.",
        statusAnswered: "απάντησε",
        statusReady: "έτοιμο",
        tooltipAnswered: "Απάντησε το {model} ({provider}). Κάντε κλικ για να επιλέξετε άλλο.",
        tooltipWillTry: "Θα δοκιμαστεί πρώτο το {model} ({provider}). Κάντε κλικ για να επιλέξετε άλλο.",
        pinHint: "Το επιλεγμένο μοντέλο δοκιμάζεται πρώτο. Αν εξαντλήσει το όριό του, το αίτημα προχωρά αυτόματα στο επόμενο.",
        emptyAnswer: "Το μοντέλο επέστρεψε κενή απάντηση. Δοκιμάστε ξανά ή επιλέξτε άλλο μοντέλο από το σήμα παραπάνω.",
        errorNetwork: "Δεν ήταν δυνατή η σύνδεση με την υπηρεσία ΤΝ. Ελέγξτε τη σύνδεσή σας και δοκιμάστε ξανά.",
        errorTimeout: "Η υπηρεσία ΤΝ δεν απάντησε εγκαίρως. Δοκιμάστε ξανά.",
        errorRateLimitMinute: "Πάρα πολλά αιτήματα στη σειρά. Δοκιμάστε ξανά σε ένα λεπτό.",
        errorRateLimitDay: "Το ημερήσιο όριο αιτημάτων εξαντλήθηκε. Δοκιμάστε αύριο.",
        errorUnavailable: "Αυτή τη στιγμή δεν υπάρχει διαθέσιμο μοντέλο. Δοκιμάστε σε λίγα λεπτά ή επιλέξτε άλλο μοντέλο από το σήμα παραπάνω.",
        errorGeneric: "Η υπηρεσία ΤΝ επέστρεψε απροσδόκητη απάντηση ({status}). Δοκιμάστε ξανά."
    }
};
