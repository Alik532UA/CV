...
export const da: Translations = {
    lastUpdate: "Sidst opdateret: 17. september 2026",
    ...
    pdf_modal: {
        ...
        dark: "Mørkt tema",
        light: "Lyst tema",
        previewAlt: "Forhåndsvisning af CV, {variant}"
    },
    ui: {
        skipToContent: "Gå til hovedindholdet",
        background: "Baggrundseffekt",
        backgroundOff: "Fra",
        backgroundParticles: "Partikler",
        backgroundWaves: "Bølger",
        backgroundShapes: "Figurer",
        particleCount: "Antal partikler",
        waveLayers: "Bølgelag",
        lineWidth: "Stregtykkelse",
        theme: "Tema",
        themeLight: "Lyst tema",
        themeDark: "Mørkt tema",
        language: "Vælg sprog",
        languageSearch: "Søg efter sprog…",
    ...
    ai: {
        subtitle: "Indsæt et jobopslag eller et link til det — AI'en sammenligner det med Aliks erfaring.",
        jobPlaceholder: "Stillingsbeskrivelse eller et link til opslaget...",
        analyze: "Analysér opslaget",
        analyzing: "Analyserer...",
        newAnalysis: "Ny analyse",
        newAnalysisHint: "Analysér et andet opslag",
        rawTitle: "AI'ens svar",
        rawNote: "Modellen gav ingen struktureret vurdering — teksten vises uændret.",
        summaryTitle: "AI'ens konklusion",
        matchLabel: "Match",
        strengths: "Styrker",
        ...
        bannerSub: "Se hvor godt opslaget passer til kandidaten",
        open: "Åbn AI Job Matcher",
        statusNoKey: "ingen nøgle",
        statusCooldown: "grænse ~{minutes} min",
        statusAnswered: "svarede",
        statusReady: "klar",
