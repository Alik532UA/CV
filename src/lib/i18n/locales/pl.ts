...
export const pl: Translations = {
    lastUpdate: "Ostatnia aktualizacja: 17 września 2026",
    ...
    experience: {
        ...
        present: "Obecnie",
        companies: {
            theater_company: "Szkoła Teatralna"
        },
        roles: {
        ...
        descriptions: {
            ...
            absoft_desc: "Testowanie urządzeń i aplikacji mobilnych dla rejestratora wideo",
    ...
    pdf_modal: {
        ...
        dark: "Ciemny motyw",
        light: "Jasny motyw",
        previewAlt: "Podgląd CV, {variant}"
    },
    ui: {
        skipToContent: "Przejdź do głównej treści",
        background: "Efekt tła",
        backgroundOff: "Wyłączone",
        backgroundParticles: "Cząsteczki",
        backgroundWaves: "Fale",
        backgroundShapes: "Kształty",
        particleCount: "Liczba cząsteczek",
        waveLayers: "Warstwy fal",
        ...
        email: "E-mail",
        languageEmpty: "Nie znaleziono języków",
        pdfVersion: "Wersja PDF",
        machineTranslated: "Wersja z tłumaczenia maszynowego — czeka na korektę native speakera",
        copyReport: "Skopiuj raport błędów — wersja {version}"
    },
    common: {
        close: "Zamknij",
        sound: "Dźwięk"
    ...
    scrollbar: {
        ...
        hold: "Przewijanie po najechaniu"
    },
    errorPage: {
