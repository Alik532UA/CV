...
export const sl: Translations = {
    lastUpdate: "Zadnja posodobitev: 17. september 2026",
    ...
    experience: {
        ...
        present: "Trenutno",
        companies: {
            theater_company: "Gledališka šola"
        },
        roles: {
        ...
        descriptions: {
            ...
            absoft_desc: "Testiranje naprav in mobilnih aplikacij za videorekorder",
    ...
    projects: {
        ...
        items: {
            ...
            adoptananimal: {
                ...
                description: "Spletišče za posvojitev živali iz odeškega zavetišča: kartice mačk in psov s filtri, priljubljeni in obrazec za prošnjo.",
                button: "Obišči stran",
                tech: "SvelteKit 2, Svelte 5, i18n, Static Adapter"
            },
            vetcrew: {
