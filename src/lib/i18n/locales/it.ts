...
export const it: Translations = {
    lastUpdate: "Ultimo aggiornamento: 17 settembre 2026",
    ...
    experience: {
        ...
        present: "Presente",
        companies: {
            theater_company: "Scuola di Teatro"
        },
        roles: {
    ...
    other: {
        highlights: "Riconoscimenti",
        iqLabel: "QI",
        olympicsLabel: "Olimpiade",
        driverLabel: "Patente",
    ...
    projects: {
        ...
        items: {
            ...
            adoptananimal: {
                ...
                description: "Sito per l’adozione di animali di un rifugio di Odessa: schede di gatti e cani con filtri, preferiti e modulo di richiesta.",
                button: "Visita il Sito",
                tech: "SvelteKit 2, Svelte 5, i18n, Static Adapter"
            },
            vetcrew: {
    ...
    pdf_modal: {
        ...
        dark: "Tema Scuro",
        light: "Tema Chiaro",
        previewAlt: "Anteprima del CV, {variant}"
    },
    ui: {
        skipToContent: "Vai al contenuto principale",
        background: "Effetto di sfondo",
        backgroundOff: "Disattivato",
        backgroundParticles: "Particelle",
        backgroundWaves: "Onde",
        backgroundShapes: "Forme",
        particleCount: "Numero di particelle",
        waveLayers: "Livelli delle onde",
        lineWidth: "Spessore della linea",
        theme: "Tema",
        themeLight: "Tema chiaro",
        themeDark: "Tema scuro",
        language: "Seleziona la lingua",
        languageSearch: "Cerca una lingua…",
    ...
    errorPage: {
        ...
        notFoundText: "Questo indirizzo non esiste. Il codice lingua nel link potrebbe essere errato.",
