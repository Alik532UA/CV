...
export const he: Translations = {
    ...
    ai: {
        ...
        emptyAnswer: "המודל החזיר תשובה ריקה. נסו שוב או בחרו מודל אחר בתגית שלמעלה.",
        errorNetwork: "לא הצלחנו להתחבר לשירות ה-AI. בדקו את החיבור ונסו שוב.",
        errorTimeout: "שירות ה-AI לא הגיב בזמן. נסו שוב.",
        errorRateLimitMinute: "יותר מדי בקשות ברצף. נסו שוב בעוד דקה.",
        errorRateLimitDay: "מכסת הבקשות היומית נוצלה. נסו שוב מחר.",
        errorUnavailable: "כרגע אין מודל זמין. נסו שוב בעוד כמה דקות או בחרו מודל אחר בתגית שלמעלה.",
        errorGeneric: "שירות ה-AI החזיר תשובה בלתי צפויה ({status}). נסו שוב."
    }
};
