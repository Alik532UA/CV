...
export const pt: Translations = {
    lastUpdate: "Última atualização: 17 de setembro de 2026",
    ...
    experience: {
        ...
        present: "Atualmente",
        companies: {
            theater_company: "Escola de Teatro"
        },
        roles: {
        ...
        descriptions: {
            ...
            absoft_desc: "Testes de dispositivos e aplicações móveis para um gravador de vídeo",
    ...
    projects: {
        ...
        items: {
            ...
            adoptananimal: {
                ...
                description: "Site de adoção de animais de um abrigo de Odessa: fichas de gatos e cães com filtros, favoritos e formulário de pedido.",
                button: "Visitar Website",
                tech: "SvelteKit 2, Svelte 5, i18n, Static Adapter"
            },
            vetcrew: {
    ...
    pdf_modal: {
        ...
        dark: "Tema Escuro",
        light: "Tema Claro",
        previewAlt: "Pré-visualização do CV, {variant}"
    },
    ui: {
        skipToContent: "Ir para o conteúdo principal",
        background: "Efeito de fundo",
        backgroundOff: "Desativado",
        backgroundParticles: "Partículas",
        backgroundWaves: "Ondas",
        backgroundShapes: "Formas",
        particleCount: "Número de partículas",
        waveLayers: "Camadas de ondas",
        lineWidth: "Espessura da linha",
        theme: "Tema",
        themeLight: "Tema claro",
        themeDark: "Tema escuro",
        language: "Selecionar idioma",
        languageSearch: "Procurar idioma…",
        profilePhoto: "Foto de perfil",
        filterProjects: "Filtrar projetos",
        email: "E-mail",
        languageEmpty: "Nenhum idioma encontrado",
        pdfVersion: "Versão PDF",
        machineTranslated: "Rascunho de tradução automática — a aguardar revisão por falante nativo",
        copyReport: "Copiar o relatório de erros — versão {version}"
    },
    common: {
        close: "Fechar",
        sound: "Som"
    ...
    scrollbar: {
        ...
        hold: "Rolagem ao passar o cursor"
    },
    errorPage: {
    ...
    ai: {
        subtitle: "Cole o texto de uma vaga ou um link para ela — a IA vai compará-la com a experiência do Alik.",
        jobPlaceholder: "Descrição da vaga, ou um link...",
        analyze: "Analisar a vaga",
        analyzing: "A analisar...",
        newAnalysis: "Nova análise",
        newAnalysisHint: "Analisar outra vaga",
        rawTitle: "Resposta da IA",
        rawNote: "O modelo não devolveu uma avaliação estruturada — mostramos o texto tal como está.",
        summaryTitle: "Conclusão da IA",
