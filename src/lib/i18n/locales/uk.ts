...
export const uk: Translations = {
    lastUpdate: "Останнє оновлення: 17 вересня 2026",
    ...
    experience: {
        ...
        companies: {
            theater_company: "Театральна школа"
        },
        roles: {
        ...
        descriptions: {
            ...
            absoft_desc: "Тестування пристроїв та мобільних додатків для відеореєстратора",
    ...
    errorPage: {
        ...
        notFoundText: "Такої адреси тут немає. Можливо, у посиланні помилка в коді мови.",
        genericTitle: "Щось пішло не так",
        genericText: "Сторінку не вдалося показати. Зазвичай допомагає перезавантаження.",
        backHome: "Повернутися до резюме"
    },
    ai: {
        subtitle: "Вставте текст вакансії або посилання на неї — AI порівняє її з досвідом Аліка.",
        jobPlaceholder: "Опис вакансії або посилання на неї...",
        analyze: "Проаналізувати вакансію",
        analyzing: "Аналізуємо...",
        newAnalysis: "Новий аналіз",
        newAnalysisHint: "Проаналізувати іншу вакансію",
        rawTitle: "Відповідь AI",
        rawNote: "Модель не повернула структуровану оцінку — показуємо текст без змін.",
        summaryTitle: "Висновок AI",
        matchLabel: "Збіг",
        ...
        bannerSub: "Перевірити, наскільки вакансія збігається з кандидатом",
        open: "Відкрити AI Job Matcher",
        statusNoKey: "немає ключа",
        statusCooldown: "ліміт ~{minutes} хв",
        statusAnswered: "відповіла",
        statusReady: "готова",
        tooltipAnswered: "Відповіла модель {model} ({provider}). Натисніть, щоб обрати іншу.",
        tooltipWillTry: "Спочатку буде спроба {model} ({provider}). Натисніть, щоб обрати іншу.",
        pinHint: "Обрана модель пробується першою. Якщо в неї закінчаться ліміти — запит піде далі по списку автоматично.",
        emptyAnswer: "Модель повернула порожню відповідь. Спробуйте ще раз або оберіть іншу модель на бейджі вгорі.",
        errorNetwork: "Не вдалося звернутися до AI-сервісу. Перевірте з'єднання і спробуйте ще раз.",
        errorTimeout: "AI-сервіс не відповів вчасно. Спробуйте ще раз.",
        errorRateLimitMinute: "Забагато запитів поспіль. Спробуйте за хвилину.",
        errorRateLimitDay: "Денний ліміт запитів вичерпано. Спробуйте завтра.",
        errorUnavailable: "Зараз жодна модель недоступна. Спробуйте за кілька хвилин або оберіть іншу модель на бейджі вгорі.",
        errorGeneric: "AI-сервіс повернув несподівану відповідь ({status}). Спробуйте ще раз."
    }
};
