 ...
 * `siblingUrl()` (`$lib/siblings`). Перелік цілей живе тепер одним місцем —
 * `PROJECT_LINKS` у `ProjectsSection.svelte`, — а словники лишили собі те, що
 * справді перекладається: назву, опис і підпис кнопки.
 */
